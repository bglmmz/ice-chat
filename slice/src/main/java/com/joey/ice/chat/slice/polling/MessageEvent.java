...
public class MessageEvent extends ChatRoomEvent
{
    public MessageEvent()
    {
        super();
    ...
    public MessageEvent(long timestamp, String name, String message)
    {
    ...
    public static final long serialVersionUID = 1324970327L;
}
