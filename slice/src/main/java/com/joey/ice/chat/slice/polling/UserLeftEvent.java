...
public class UserLeftEvent extends ChatRoomEvent
{
    ...
    public UserLeftEvent(long timestamp, String name)
    {
    ...
    clone()
    {
        return (UserLeftEvent)super.clone();
    }

    public static final long serialVersionUID = -1214502410L;
}
